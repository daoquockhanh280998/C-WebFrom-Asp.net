...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    public void LoadCategory()
    {
        ...
        //var data = db.ArticleCategories.Select(x => new { x.ArticleCategoryID, x.Title });
    ...
    public void LoadData()
    {
        ...
        DBEntities db = new DBEntities();
        var query = from mc in db.ArticleMainCategories
                    from c in mc.ArticleCategories
        ...
        string url = "~/Admin/ArticleList.aspx?catid={0}&keyword={1}&page={2}".StringFormat(catID, keyword, "{0}");
    ...
    {
        string url = "/Admin/ArticleList.aspx?";
