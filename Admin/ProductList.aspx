<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ProductList.aspx.cs" Inherits="Admin_ProductCategoryList" %>
            ...
            <div class="col-md-12">
                <div class="head clearfix">
                    ...
                    <ul class="buttons col-md-1">
                        <li>
                            <a href="ProductEdit.aspx" title="Thêm mới" class="fa fa-plus-circle"></a>
                        </li>
                        <li>
                            <a href="#" title="Xóa chọn" class="fa fa-trash-alt" onclick="alert('Chức năng xóa hàng loạt này hiện chưa có.')"></a>
                        </li>
                    </ul>
                </div>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th width="80px" class="center">Giá Mới
                                    </th>
                                    <th>Tiêu đề /Loại / Mô tả / Khuyến Mãi
                                    </th>
                                ...
                                <asp:Repeater ID="Repeater_Main" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="center middle"><%# Eval("ProductID") %>
                                            </td>
                                            <td>
                                                <div class="image">
                                            ...
                                            <td class="center middle"><%# Eval("OldPrice","{0:0,00}") %>
                                            </td>
                                            <td class="center middle"><%# Eval("Price","{0:0,00}") %>
                                            </td>
                                            <td class="middle">
                                                <h4>
                                                    <%# Eval("Title") %>
                                                ...
                                                <p>Khuyến Mãi: <b><%# Eval("Promotions") %></b></p>
                                                <p>Mô Tả:<%# Eval("Dercription") %></p>
                                            </td>
                                            <td class="center middle"><%# Eval("Quantity") %>
                                            </td>
                                            ...
                                            <td>
                                                <p class="info">
                                                    <a class="btn btn-block fancybox-iframe" href='<%# Eval("ProductID","ProductDetail.aspx?id={0}") %>'>
                                                        <i class="fa fa fa-exchange-alt" style="padding-right: 5px;"></i>
                                                        <span class="icon-refresh icon-white"></span>Hiển Thị Chi Tiết
                                                    </a>

                                                    <a class="btn btn-block" href='<%# Eval("ProductID","ProductEdit.aspx?id={0}") %>'>
                                                    ...
                                                    <asp:LinkButton ID="LinkButton_Delete" OnClick="LinkButton_Delete_Click"
                                                        CommandArgument='<%# Eval("ProductID") %>' OnClientClick="ConfirmDelete()"
                                                    ...
                                                    <asp:LinkButton ID="LinkButton_Status" OnClick="LinkButton_Status_Click" CommandArgument='<%# Eval("ProductID") %>' runat="server"
