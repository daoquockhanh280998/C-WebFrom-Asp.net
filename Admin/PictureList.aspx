<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="PictureList.aspx.cs" Inherits="Admin_Default" %>
            ...
            <div class="col-md-12">
                <div class="head clearfix">
                    <div class="isw-list col-md-11">
                        ...
                        <h2>Danh Sách Hình Ảnh
                        </h2>
                    </div>
                    <ul class="buttons col-md-1">
                        <li>
                            <a href="PictureEdit.aspx" title="Thêm mới" class="fa fa-plus-circle"></a>
                        </li>
                        <li>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th width="500px" class="center">Hình
                                    </th>
                                ...
                                <asp:Repeater ID="Repeater_Main" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="center middle"><%# Eval("PictureID") %>
                                            </td>
                                            <td class="middle">
                                                <h4>
                                                    <%# Eval("Title") %>
                                            ...
                                            <td>
                                                <p class="info">
                                                    <a class="btn btn-block fancybox-iframe" href='<%# Eval("PictureID","PictureDetail.aspx?id={0}") %>'>
                                                        <i class="fa fa fa-exchange-alt" style="padding-right: 5px;"></i>
                                                        <span class="icon-refresh icon-white"></span>Hiển Thị Chi Tiết
                                                    </a>

                                                    <a class="btn btn-block" href='<%# Eval("PictureID","PictureEdit.aspx?id={0}") %>'>
                                                    ...
                                                    <asp:LinkButton ID="LinkButton_Delete" OnClick="LinkButton_Delete_Click"
                                                        CommandArgument='<%# Eval("PictureID") %>' OnClientClick="ConfirmDelete()"
                                                    ...
                                                    <asp:LinkButton ID="LinkButton_Status" OnClick="LinkButton_Status_Click" CommandArgument='<%# Eval("PictureID") %>' runat="server"
