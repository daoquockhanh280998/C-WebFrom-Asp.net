                ...
                <div class="col-md-3">
                    <div class="head clearfix">
                        <div class="isw-folder">
                            ...
                            <h2>Chi Tiết loại tài khoản Đang chọn
                            </h2>
                        </div>
                    </div>
                        ...
                        <div class="account-contact-info">
                            <div>
                                ...
                                <div class="bl clearfix">
                                    ...
                                    <div class="col-md-6">
                                        <input runat="server" id="input_ID" type="text" class="col-md-12" />
                                        <div class="title">
                                            <span>Sử dụng chữ cái (hoặc thêm số). Không gõ dấu và không khoảng trắng. VD: SupperAdmin
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                    ...
                                    <div class="col-md-3">
                                        <input runat="server" id="input_Position" type="text" class="col-md-12" data-toggle="tooltip" data-placement="top" title="Dùng để sắp xếp thứ tự" />
                                        <div class="title">
                                            <span>Nhập số hoặc để trống
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bl clearfix">
                                    ...
                                    <div class="col-md-10 form-select">
                                        <input runat="server" id="input_Title" class="col-md-12" type="text" />
                                        <div class="title">
                                ...
                                <div class="bl clearfix">
                                    ...
                                    <div class="col-md-10 form-select">
                                        <textarea runat="server" id="textarea_Decription" class="col-md-12" type="text" />
